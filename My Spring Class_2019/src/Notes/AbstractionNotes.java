...
3. Interface: meant to be implemented
		...
		6. class extends class type, interface extends interface  
					( can only extend one)
			
		5. class implements interface or interfaces
		
		6. when class implements interface, class can inherit all members 
